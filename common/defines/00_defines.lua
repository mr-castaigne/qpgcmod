...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2026.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NProduction = {
	...
	LICENSE_IC_COST_YEAR_INCREASE = 1,					-- IC cost equipment for every year of equipment after 2026
